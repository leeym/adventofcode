...
<div id="sidebar">
<div id="sponsor"><div class="quiet">Our <a href="/2022/sponsors">sponsors</a> help make Advent of Code possible:</div><div class="sponsor"><a href="https://www.riotgames.com/en/work-with-us#craft=software-engineering-group" target="_blank" onclick="if(ga)ga('send','event','sponsor','sidebar',this.href);" rel="noopener">Riot Games</a> - Team up with us to craft unforgettable experiences for players!</div></div>
</div><!--/sidebar-->
